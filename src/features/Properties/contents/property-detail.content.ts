...
const propertyDetailContent = {
  ...
  content: {
    ...
    amenityLabels: {
      wifi:               t({ en: "WiFi",                   bg: "WiFi" }),
      air_conditioning:   t({ en: "Air Conditioning",       bg: "Климатик" }),
      kitchen:            t({ en: "Kitchen",                bg: "Кухня" }),
      washing_machine:    t({ en: "Washing Machine",        bg: "Перална машина" }),
      fireplace:          t({ en: "Fireplace",              bg: "Камина" }),
      bbq:                t({ en: "BBQ",                    bg: "Барбекю" }),
      mountain_view:      t({ en: "Mountain View",          bg: "Гледка към планината" }),
      ski_storage:        t({ en: "Ski Storage",            bg: "Съхранение на ски" }),
      breakfast_included: t({ en: "Breakfast Included",     bg: "Закуска включена" }),
      reception_24h:      t({ en: "24h Reception",          bg: "24ч рецепция" }),
      sea_view:           t({ en: "Sea View",               bg: "Гледка към морето" }),
