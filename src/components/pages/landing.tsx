...
export function Landing() {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex w-full flex-col gap-8 px-3 py-6 md:gap-14 md:px-6 md:py-16">
        {/* Hero + Search */}
        <div className="flex flex-col gap-2 w-full max-w-4xl mx-auto md:gap-6">
        ...
        {/* Offers */}
        <div className="flex flex-col gap-3 mx-auto max-w-4xl md:gap-4">
          ...
          <div className="flex w-full flex-col gap-3 md:gap-4">
            {isLoading ? (
              <>
                <div className="h-28 max-w-4xl w-full animate-pulse rounded-lg bg-muted md:h-36" />
                <div className="h-28 max-w-4xl w-full animate-pulse rounded-lg bg-muted md:h-36" />
                <div className="h-28 max-w-4xl w-full animate-pulse rounded-lg bg-muted md:h-36" />
              </>
            ) : (
